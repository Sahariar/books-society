        ...
        <div className="min-h-screen w-60 p-3 space-y-2 bg-white border-r-2">
            ...
            <div className="divide-y divide-gray-700">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                    <li className={router.pathname == '/dashboard' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlineDashboard className='text-2xl' />
                            <span>Dashboard</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/addBook' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard/addBook" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlinePlus className='text-2xl' />
                            <span>Add Book</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/allBooks' ? 'font-bold border-l-4 border-primary' : ''}>
                    ...
                    <li className={router.pathname == '/dashboard/myBooks' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard/myBooks" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlineBook className='text-2xl' />
                            <span>My Books</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/allReviews' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard/allReviews" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlineUnorderedList className='text-2xl' />
                            <span>All Reviews</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/myReviews' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard/myReviews" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlineMessage className='text-2xl' />
                            <span>My Reviews</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/addAuthor' ? 'font-bold border-l-4 border-primary' : ''}>
                        <Link href="/dashboard/addAuthor" className="flex items-center p-2 space-x-3 rounded-md">
                            <AiOutlineUserAdd className='text-2xl' />
                            <span>Add Author</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/allUsers' ? 'font-bold border-l-4 border-primary' : ''}>
                    ...
                    <li className={router.pathname == '/dashboard/chat' ? 'font-bold border-l-4 border-primary' : ''} >
                        <Link href='/dashboard/chat' className="flex items-center p-2 space-x-3 rounded-md">
                            <AiFillWechat className='text-2xl' />
                            <span>Chat</span>
                        </Link>
                    </li>
                    <li className={router.pathname == '/dashboard/payment' ? 'font-bold border-l-4 border-primary' : ''} >
