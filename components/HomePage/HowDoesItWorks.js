import {FaEdit, FaBook, FaPenSquare, FaEnvelopeOpenText} from 'react-icons/fa';
const HowDoesItWorks = () => {
    return (
        <div className="container mx-auto pb-5">
            <h1 className='text-center pb-10 pt-24 text-4xl font-bold'>
                    How Does It Works
            </h1>
            <div className="grid gap-5 grid-cols-2 md:grid-cols-4">
                ...
                <div className="bg-white p-5 rounded-lg shadow-lg">
                    ...
                    <h3 className='text-3xl font-semibold text-center mb-4'>Chat With Others Who Read The Books</h3>
