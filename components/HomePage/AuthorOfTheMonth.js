				...
				<div className="flex flex-col-reverse xl:flex-row">
					<div className="w-full lg:w-6/12 p-2">
						<div className="mx-auto">
							<Image
								className="rounded-lg my-6 border-4 border-primary bg-secondary/40 mx-auto"
								src="https://i.ibb.co/znmFwxX/belle.jpg"
								width={600}
								height={600}
								alt="teacher"
							/>
					...
					<div className="w-full lg:w-6/12 p-2">
						<div className=" p-5 lg:p-20">
							...
							<p className="">
								Bella Mackie is a former journalist who previously worked for
								The Guardian and Vice News. She writes a twice monthly Vogue
								column. Her first book, Jog On, was a memoir about mental health
								and running. It was a number two bestseller (just underneath
								Michelle Obama, which is a hallowed spot).
							</p>
