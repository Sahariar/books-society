...
const Footer = () => {
    return (
        <>
   <footer className="px-4 divide-y bg-neutral text-white">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
		<Logo 
        width={20}
        height={20}
        color={'text-white'}></Logo>
		</div>
	...
	<div className="py-6 text-sm text-center">© 2022 Book Society. All rights reserved.</div>
</footer>
        </>
    );
};
