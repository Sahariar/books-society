...
const index = () => {
			...
			<main>
				...
				<div className="title-area py-5 bg-neutral">
					<div className="container mx-auto">
						...
						<h2 className="text-4xl  font-bold text-center">Contact Books Society</h2>
	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
			...
			<button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75  bg-primary focus:ring-primary hover:ring-neutral">Submit</button>
		</form>
	</div>
</div>
					</div>
